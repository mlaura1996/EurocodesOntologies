...
g.add((EC1990['Action'], SKOS.definition, Literal('Set of forces (loads) applied to the structure (direct action) or set of imposed deformations or accelerations caused for example, by temperature changes, moisture variation, uneven settlement or earthquakes (indirect action). The value of the action is a characteristic value.')))
...
g.add((EC1990['hasPartialFactor'], RDFS.label, Literal('Factor Parcial', lang='es')))
...
g.add((EC1990['hasReductionFactor'], RDFS.label, Literal('.', lang='es')))
...
g.add((EC1990['hasVariableActionPartialFactor'], RDFS.subPropertyOf, EC1990.PartialFactor))
g.add((EC1990['hasVariableActionPartialFactor'], RDFS.label, Literal('has variable action partial factor', lang='en')))
g.add((EC1990['hasVariableActionPartialFactor'], RDFS.label, Literal('Factor Parcial de Acción Variable', lang='es')))
...
g.add((EC1990['hasMaterialPartialFactor'], RDFS.subPropertyOf, EC1990.PartialFactor))
g.add((EC1990['hasMaterialPartialFactor'], RDFS.label, Literal('has material partial factor', lang='en')))
g.add((EC1990['hasMaterialPartialFactor'], RDFS.label, Literal('Factor Parcial del Modelo del Material', lang='es')))
...
g.add((EC1990['hasCombinationFactor'], RDFS.label, Literal('Factor de Combinación', lang='es')))
...
g.add((EC1990['hasFrequentFactor'], RDFS.label, Literal('Factor Frecuente', lang='es')))
...
g.add((EC1990['hasQuasiPermanentFactor'], RDFS.label, Literal('Factor Cuasi-permanente', lang='es')))
