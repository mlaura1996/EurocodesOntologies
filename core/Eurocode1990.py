...
# Construction Works
g.add((EC1990['ConstructionWorks'], RDF.type, OWL.Class))
g.add((EC1990['ConstructionWorks'], RDFS.label, Literal('Construction Works', lang='en')))
g.add((EC1990['ConstructionWorks'], RDFS.label, Literal('Obras de Construcción', lang='es')))
g.add((EC1990['ConstructionWorks'], RDFS.comment, Literal('Everything that is constructed or results from construction operations. The term covers both building and civil engineering works comprising structural, non-structural and geotechnical elements.', lang='en')))
g.add((EC1990['ConstructionWorks'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.1.1')))
g.add((EC1990['ConstructionWorks'], SKOS.definition, Literal('Physical entity that results from construction operations')))
...
g.add((EC1990['Building'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.1.2')))
...
g.add((EC1990['CivilEngineeringWork'], RDFS.subClassOf, EC1990.ConstructionWorks))
...
g.add((EC1990['CivilEngineeringWork'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.1.2')))
...
g.add((EC1990['Structure'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.1.6')))
...
g.add((EC1990['StructuralSystem'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.1.9')))
...
g.add((EC1990['LimitState'], RDFS.comment, Literal('States beyond which the structure no longer fulfils the relevant design criteria.', lang='en')))
g.add((EC1990['LimitState'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.12')))
g.add((EC1990['LimitState'], SKOS.definition, Literal('Critical structural state that must not be exceeded')))
...
g.add((EC1990['UltimateLimitState'], RDFS.comment, Literal('States associated with collapse or with other similar forms of structural failure. They generally correspond to the maximum load-carrying resistance of a structure or structural member.', lang='en')))
g.add((EC1990['UltimateLimitState'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.13')))
...
g.add((EC1990['ServiceabilityLimitState'], RDFS.comment, Literal('States that correspond to conditions beyond which specified service requirements for a structure or structural member are no longer met.', lang='en')))
g.add((EC1990['ServiceabilityLimitState'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.14')))
...
g.add((EC1990['EQU'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.1(1)P a)')))
...
g.add((EC1990['STR'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.1(1)P b)')))
...
g.add((EC1990['GEO'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.1(1)P c)')))
...
g.add((EC1990['FAT'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.1(1)P d)')))
...
g.add((EC1990['UPL'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.1(1)P e)')))
...
g.add((EC1990['HYD'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.1(1)P f)')))
...
g.add((EC1990['ReversibleServiceabilityLimitState'], RDFS.comment, Literal('Serviceability limit states where no consequences of actions exceeding the specified service requirements will remain when the actions are removed.', lang='en')))
...
g.add((EC1990['IrreversibleServiceabilityLimitState'], RDFS.comment, Literal('Serviceability limit states where some consequences of actions exceeding the specified service requirements will remain when the actions are removed.', lang='en')))
...
g.add((EC1990['DesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.2')))
...
g.add((EC1990['PersistentDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.4')))
...
g.add((EC1990['TransientDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.3')))
...
g.add((EC1990['AccidentalDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.5')))
...
g.add((EC1990['FireDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.6')))

g.add((EC1990['ExplotionDesignSituation'], RDF.type, OWL.Class))
g.add((EC1990['ExplotionDesignSituation'], RDFS.subClassOf, EC1990.AccidentalDesignSituation))
g.add((EC1990['ExplotionDesignSituation'], RDFS.label, Literal('Explosion Design Situation', lang='en')))
g.add((EC1990['ExplotionDesignSituation'], RDFS.comment, Literal('Accidental design situation involving explosion conditions.', lang='en')))
g.add((EC1990['ExplotionDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.5')))
...
g.add((EC1990['ImpactDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.5')))
...
g.add((EC1990['LocalizedFailureDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.5')))
...
g.add((EC1990['SeismicDesignSituation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.7')))
...
g.add((EC1990['Action'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.1')))
g.add((EC1990['Action'], SKOS.definition, Literal('Set of forces or imposed deformations applied to the structure')))
g.add((EC1990['Action'], SKOS.example, Literal('dead load, live load, wind load, thermal action')))
...
g.add((EC1990['DirectAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.1 a)')))
...
g.add((EC1990['IndirectAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.1 b)')))
...
g.add((EC1990['PermanentAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.3')))
...
g.add((EC1990['VariableAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.4')))
...
g.add((EC1990['AccidentalAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.5')))
...
g.add((EC1990['SeismicAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.6')))
g.add((EC1990['SeismicAction'], SKOS.altLabel, Literal('AE')))
...
g.add((EC1990['FixedAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.8')))
...
g.add((EC1990['FreeAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.9')))
...
g.add((EC1990['StaticAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.11')))
...
g.add((EC1990['DynamicAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.12')))
...
g.add((EC1990['QuasiStaticAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.13')))
...
g.add((EC1990['GeotechnicalAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.7')))
...
g.add((EC1990['CombinationOfActions'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.22')))
g.add((EC1990['CombinationOfActions'], SKOS.definition, Literal('Set of design values for simultaneous verification of limit states')))

g.add((EC1990['ULSCombinations'], RDF.type, OWL.Class))
g.add((EC1990['ULSCombinations'], RDFS.subClassOf, EC1990.CombinationOfActions))
g.add((EC1990['ULSCombinations'], RDFS.label, Literal('Ultimate Limit State Combinations', lang='en')))
g.add((EC1990['ULSCombinations'], RDFS.label, Literal('Combinaciones ELU', lang='es')))
g.add((EC1990['ULSCombinations'], RDFS.comment, Literal('Combinations of actions for verifying ultimate limit states.', lang='en')))
g.add((EC1990['ULSCombinations'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.3')))

g.add((EC1990['FundamentalCombination'], RDF.type, OWL.Class))
g.add((EC1990['FundamentalCombination'], RDFS.subClassOf, EC1990.ULSCombinations))
...
g.add((EC1990['FundamentalCombination'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.3.2')))

g.add((EC1990['AccidentalCombination'], RDF.type, OWL.Class))
g.add((EC1990['AccidentalCombination'], RDFS.subClassOf, EC1990.ULSCombinations))
...
g.add((EC1990['AccidentalCombination'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.3.3')))

g.add((EC1990['SeismicCombination'], RDF.type, OWL.Class))
g.add((EC1990['SeismicCombination'], RDFS.subClassOf, EC1990.ULSCombinations))
...
g.add((EC1990['SeismicCombination'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.4.3.4')))

g.add((EC1990['SLSCombinations'], RDF.type, OWL.Class))
g.add((EC1990['SLSCombinations'], RDFS.subClassOf, EC1990.CombinationOfActions))
g.add((EC1990['SLSCombinations'], RDFS.label, Literal('Serviceability Limit State Combinations', lang='en')))
g.add((EC1990['SLSCombinations'], RDFS.label, Literal('Combinaciones ELS', lang='es')))
g.add((EC1990['SLSCombinations'], RDFS.comment, Literal('Combinations of actions for verifying serviceability limit states.', lang='en')))
g.add((EC1990['SLSCombinations'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.5.3')))

g.add((EC1990['CharacteristicCombination'], RDF.type, OWL.Class))
g.add((EC1990['CharacteristicCombination'], RDFS.subClassOf, EC1990.SLSCombinations))
...
g.add((EC1990['CharacteristicCombination'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.5.3(2)a')))

g.add((EC1990['FrequentCombination'], RDF.type, OWL.Class))
g.add((EC1990['FrequentCombination'], RDFS.subClassOf, EC1990.SLSCombinations))
...
g.add((EC1990['FrequentCombination'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.5.3(2)b')))

g.add((EC1990['QuasiPermanentCombination'], RDF.type, OWL.Class))
g.add((EC1990['QuasiPermanentCombination'], RDFS.subClassOf, EC1990.SLSCombinations))
...
g.add((EC1990['QuasiPermanentCombination'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 6.5.3(2)c')))
...
g.add((EC1990['EffectOfAction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
g.add((EC1990['EffectOfAction'], SKOS.definition, Literal('Response of structure or structural members to applied actions')))
...
g.add((EC1990['InternalForce'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
g.add((EC1990['InternalForce'], SKOS.altLabel, Literal('F')))
...
g.add((EC1990['BendingMoment'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['AxialForce'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['ShearForce'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['TorsionalMoment'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['Stress'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['NormalStress'], RDFS.comment, Literal('Stress acting perpendicular to a surface.', lang='en')))
g.add((EC1990['NormalStress'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['ShearStress'], RDFS.comment, Literal('Stress acting parallel to a surface.', lang='en')))
g.add((EC1990['ShearStress'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['PrincipalStress'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['Strain'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['Deformation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['LinearDeformation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['Deflection'], RDFS.comment, Literal('Vertical deflection of a structural member.', lang='en')))
g.add((EC1990['Deflection'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.6')))
...
g.add((EC1990['Displacement'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.6')))
...
g.add((EC1990['AngularDeformation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['Rotation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['Twist'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['VolumetricDeformation'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['AccelerationEffect'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 4.1.5(2)')))
...
g.add((EC1990['FatigueEffect'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 3.1(5)')))
...
g.add((EC1990['Reaction'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.3.2')))
...
g.add((EC1990['MaterialProperty'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 4.2')))

g.add((EC1990['GeometricalData'], RDF.type, OWL.Class))
g.add((EC1990['GeometricalData'], RDFS.label, Literal('Geometrical Data', lang='en')))
g.add((EC1990['GeometricalData'], RDFS.label, Literal('Datos Geométricos', lang='es')))
g.add((EC1990['GeometricalData'], RDFS.comment, Literal('Geometrical properties and dimensions of structural elements.', lang='en')))
g.add((EC1990['GeometricalData'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 4.3')))
...
g.add((EC1990['Resistance'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.15')))
...
g.add((EC1990['DesignWorkingLife'], DCTERMS.source, Literal('UNE-EN 1990:2019, Section 1.5.2.8')))
...
g.add((EC1990['isDesignedFor'], RDFS.label, Literal('applies to', lang='en')))
g.add((EC1990['isDesignedFor'], RDFS.label, Literal('se aplica a', lang='es')))
g.add((EC1990['isDesignedFor'], RDFS.comment, Literal('Relates an action to the structural member or structure it acts upon.', lang='en')))
...
g.add((EC1990['resultsIn'], RDF.type, OWL.ObjectProperty))
g.add((EC1990['resultsIn'], RDFS.label, Literal('results in', lang='en')))
g.add((EC1990['resultsIn'], RDFS.label, Literal('resulta en', lang='es')))
g.add((EC1990['resultsIn'], RDFS.comment, Literal('Relates an action to the effect it produces in the structure.', lang='en')))
g.add((EC1990['resultsIn'], RDFS.domain, EC1990.Action))
g.add((EC1990['resultsIn'], RDFS.range, EC1990.EffectOfAction))
...
g.add((EC1990['ULSCombinations'], OWL.disjointWith, EC1990.SLSCombinations))
...
g.add((ref, SKOS.hasTopConcept, EC1990.ConstructionWorks))
...
# Hierarchical relationships for better organization
g.add((EC1990['Structure'], RDFS.subClassOf, EC1990.ConstructionWorks))
