...
g.add((EC1990['PermanentActionPartialFactor'], RDFS.comment, Literal('Partial factor applied to permanent actions.', lang='en')))
...
g.add((EC1990['VariableActionPartialFactor'], RDFS.comment, Literal('Partial factor applied to variable actions.', lang='en')))
...
g.add((EC1990['MaterialPartialFactor'], RDFS.comment, Literal('Partial factor for material properties taking account of the possibility of an unfavourable deviation of a material property from its characteristic value.', lang='en')))
g.add((EC1990['MaterialPartialFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 6.3.3')))
...
g.add((EC1990['MaterialModelPartialFactor'], RDFS.comment, Literal('Partial factor for material properties also accounting for model uncertainties and dimensional variations.', lang='en')))
...
g.add((EC1990['MaterialModelPartialFactor'], SKOS.altLabel, Literal('γ_M')))
