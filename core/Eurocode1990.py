...
g.add((EC1990['hasRepresentativeValue'], RDFS.comment, Literal('Relates a Quantity  with its Representative Value.', lang='en')))
...
g.add((EC1990['hasNominalValue'], RDFS.comment, Literal('Relates a Quantity  with its Nominal Value.', lang='en')))
...
g.add((EC1990['hasDesignValue'], RDFS.comment, Literal('Relates a Quantity  with its Design Value.', lang='en')))
...
g.add((EC1990['hasCharacteristicValue'], RDFS.comment, Literal('Relates a Quantity  with its Characteristic Value.', lang='en')))
...
g.add((EC1990['hasMeanValue'], RDFS.comment, Literal('Relates a Quantity  with its Mean Value.', lang='en')))
...
g.add((EC1990['hasLowerValue'], RDFS.comment, Literal('Relates a Quantity  with its Lower Value.', lang='en')))
...
g.add((EC1990['hasUpperValue'], RDFS.comment, Literal('Relates a Quantity  with its Upper Value.', lang='en')))
...
g.add((EC1990['usesActionValue'], RDFS.comment, Literal('Relates a combination of actions to the individual actions it contains.', lang='en')))
...
g.add((EC1990['isVerifiedFor'], RDFS.comment, Literal('Relates a limit state to the combination of actions used for its verification.', lang='en')))
