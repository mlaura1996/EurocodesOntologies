...
g.add((EC1990['TemporaryStructure'], RDF.type, OWL.Class))
...
g.add((EC1990['ReplacableStructuralElements'], RDF.type, OWL.Class))
...
g.add((EC1990['AgriculturalStructure'], RDF.type, OWL.Class))
...
g.add((EC1990['BuildingStructure'], RDF.type, OWL.Class))
...
g.add((EC1990['BridgeStructure'], RDF.type, OWL.Class))
...
g.add((EC1990['MonumentalBuldingStructure'], RDF.type, OWL.Class))
...
g.add((EC1990['CivilEngineeringStructure'], RDF.type, OWL.Class))
...
g.add((EC1990['FundamentalCombination'], RDF.type, OWL.NamedIndividual))
g.add((EC1990['FundamentalCombination'], RDF.type, EC1990.ULSCombination))
...
g.add((EC1990['AccidentalCombination'], RDF.type, OWL.NamedIndividual))
g.add((EC1990['AccidentalCombination'], RDF.type, EC1990.ULSCombination))
...
g.add((EC1990['SeismicCombination'], RDF.type, OWL.NamedIndividual))
g.add((EC1990['SeismicCombination'], RDF.type, EC1990.ULSCombination))
...
g.add((EC1990['CharacteristicCombination'], RDF.type, OWL.NamedIndividual))
g.add((EC1990['CharacteristicCombination'], RDF.type, EC1990.SLSCombination))
...
g.add((EC1990['FrequentCombination'], RDF.type, OWL.NamedIndividual))
g.add((EC1990['FrequentCombination'], RDF.type, EC1990.SLSCombination))
...
g.add((EC1990['QuasiPermanentCombination'], RDF.type, OWL.NamedIndividual))
g.add((EC1990['QuasiPermanentCombination'], RDF.type, EC1990.SLSCombination))
...
g.add((EC1990['hasCharacteristicValue'], DCTERMS.source, Literal('EN 1990:2002, Section 1.5.3.14')))
g.add((EC1990['hasCharacteristicValue'], SKOS.altLabel, Literal('F_k')))
...
g.add((EC1990['hasDesignValue'], DCTERMS.source, Literal('EN 1990:2002, Section 1.5.3.21')))
g.add((EC1990['hasDesignValue'], SKOS.altLabel, Literal('F_d')))
...
g.add((EC1990['hasRepresentativeValue'], DCTERMS.source, Literal('EN 1990:2002, Section 1.5.3.20')))
g.add((EC1990['hasRepresentativeValue'], SKOS.altLabel, Literal('F_rep')))
...
g.add((EC1990['PartialFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 6.3.1')))
g.add((EC1990['PartialFactor'], SKOS.altLabel, Literal('γ_f')))
...
g.add((EC1990['PermanentActionPartialFactor'], RDFS.comment, Literal('Partial factor applied to permanent actions, also accounting for model uncertainties and dimensional variations.', lang='en')))
g.add((EC1990['PermanentActionPartialFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 6.3.1')))
g.add((EC1990['PermanentActionPartialFactor'], RDFS.domain, EC1990.PermanentAction))
g.add((EC1990['PermanentActionPartialFactor'], SKOS.altLabel, Literal('γ_G')))

g.add((EC1990['FavourablePermanentActionPartialFactor'], RDF.type, OWL.DatatypeProperty))
g.add((EC1990['FavourablePermanentActionPartialFactor'], RDFS.subPropertyOf, EC1990.PermanentActionPartialFactor))
g.add((EC1990['FavourablePermanentActionPartialFactor'], RDFS.label, Literal('Favourable Permanent Action Partial Factor', lang='en')))
g.add((EC1990['FavourablePermanentActionPartialFactor'], RDFS.label, Literal('Factor Parcial de Acción Permanente Favorable', lang='es')))
g.add((EC1990['FavourablePermanentActionPartialFactor'], RDFS.comment, Literal('Partial factor applied to permanent actions accounting for favourable effect of the action.', lang='en')))
g.add((EC1990['FavourablePermanentActionPartialFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 6.3.2.3(P)')))
g.add((EC1990['FavourablePermanentActionPartialFactor'], RDFS.domain, EC1990.PermanentAction))
g.add((EC1990['FavourablePermanentActionPartialFactor'], SKOS.altLabel, Literal('γ_G,sup')))

g.add((EC1990['UnfavourablePermanentActionPartialFactor'], RDF.type, OWL.DatatypeProperty))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], RDFS.subPropertyOf, EC1990.PermanentActionPartialFactor))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], RDFS.label, Literal('Unavourable Permanent Action Partial Factor', lang='en')))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], RDFS.label, Literal('Factor Parcial de Acción Permanente Desfavorable', lang='es')))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], RDFS.comment, Literal('Partial factor applied to permanent actions accounting for unfavourable effect of the action.', lang='en')))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 6.3.2.3(P)')))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], RDFS.domain, EC1990.PermanentAction))
g.add((EC1990['UnfavourablePermanentActionPartialFactor'], SKOS.altLabel, Literal('γ_G,sup')))
...
g.add((EC1990['MaterialPartialFactor'], RDFS.label, Literal('Material-Model Partial Factor', lang='en')))
g.add((EC1990['MaterialPartialFactor'], RDFS.label, Literal('Factor Parcial del Modelo del Material', lang='es')))
...
g.add((EC1990['FrequentFactor'], RDFS.comment, Literal('Factor for frequent value of a variable action, determined so that either the total time within the reference period during which it is exceeded is only a small given part of the reference period, or the frequency of it being exceeded is limited to a given value.', lang='en')))
g.add((EC1990['FrequentFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 1.5.3.17')))
g.add((EC1990['FrequentFactor'], RDFS.domain, EC1990.VariableAction))
g.add((EC1990['FrequentFactor'], RDFS.range, XSD.decimal))
g.add((EC1990['FrequentFactor'], SKOS.altLabel, Literal('ψ_1')))
...
g.add((EC1990['QuasiPermanentFactor'], RDFS.comment, Literal('Factor for quasi-permanent value of a variable action, determined so that the total period of time for which it will be exceeded is a large fraction of the reference period.', lang='en')))
g.add((EC1990['QuasiPermanentFactor'], DCTERMS.source, Literal('EN 1990:2002, Section 1.5.3.18')))
...
g.add((EC1990['QuasiPermanentFactor'], SKOS.altLabel, Literal('ψ_2')))
